...
export const CONTENT_DB = [
  ...
  { id: 'c4', title: 'Product Strategy 101', type: 'Course', skillId: 's5', minLevel: 0, xp: 5, duration: '45m', gradient: 'linear-gradient(135deg, #f59e0b 0%, #b45309 100%)' },
  { id: 'c5', title: 'Rust for JS Developers', type: 'Course', skillId: 's6', minLevel: 50, xp: 5, duration: '4h', gradient: 'linear-gradient(135deg, #ec4899 0%, #be185d 100%)' },
  ...
  { id: 'c7', title: 'Negotiation for Engineers', type: 'Workshop', skillId: 's5', minLevel: 0, xp: 5, duration: '1 day', gradient: 'linear-gradient(135deg, #f43f5e 0%, #e11d48 100%)' },
